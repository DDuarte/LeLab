...
public:
    ...
    {
        // materials
        mat1_shininess[0] =    128.0;

        mat1_specular[0] = 0.3; //{ 0.3, 0.3, 0.3, 1.0 };
        mat1_specular[1] = 0.3;
        mat1_specular[2] = 0.3;
        mat1_specular[3] = 1.0;

        mat1_diffuse[0] = 0.7; //   =    { 0.7, 0.7, 0.7, 1.0 };
        mat1_diffuse[1] = 0.7;
        mat1_diffuse[2] = 0.7;
        mat1_diffuse[3] = 1.0;

        mat1_ambient[0] = 0.7; //  =    { 0.7, 0.7, 0.7, 1.0 };
        mat1_ambient[1] = 0.7;
        mat1_ambient[2] = 0.7;
        mat1_ambient[3] = 1.0;
        ...
        light0_position[0] = 4.0; //{ 0.3, 0.3, 0.3, 1.0 };
        light0_position[1] = 6.0;
        light0_position[2] = 3.0;
        light0_position[3] = 1.0;

        light0_ambient[0] = light0_ambient[1] = light0_ambient[2] =  0.0; light0_ambient[3] = 1.0;
        light0_diffuse[0] = light0_diffuse[1] = light0_diffuse[2] =  0.8; light0_diffuse[3] = 1.0;
        light0_specular[0] = light0_specular[1] = light0_specular[2] =  0.8; light0_specular[3] = 1.0;
        light0_kc = 1.0;
        light0_kl = 0.0;
        light0_kq = 0.0;

        // Ambient light source
        light_ambient[0] = light_ambient[1] = light_ambient[2] =  0.2; light_ambient[3] = 1.0;
    }
    bool Start();
    void Update();
    void Render() const;
